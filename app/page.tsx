...
const Logo = dynamic(
  () => import("src/components/canvas/Examples").then(mod => mod.Logo),
  { ssr: false },
);
const Dog = dynamic(
  () => import("src/components/canvas/Examples").then(mod => mod.Dog),
  { ssr: false },
);
const Duck = dynamic(
  () => import("src/components/canvas/Examples").then(mod => mod.Duck),
  { ssr: false },
);
const View = dynamic(
